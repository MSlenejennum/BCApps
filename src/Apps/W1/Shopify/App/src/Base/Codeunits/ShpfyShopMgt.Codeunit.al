...
codeunit 30211 "Shpfy Shop Mgt."
{
    var
        ...
        NorthAmericaLocalizationNotificationMsg: Label 'Install the Shopify Connector NA extension to enable North America-specific features, including Copilot-assisted matching of Shopify tax lines to Business Central tax jurisdictions.';
